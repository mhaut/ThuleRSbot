...
class LibVCA():
    ...
    def __init__(self, num_endmembers=0, verbose=False, snr_input=0):
        self.num_endmembers = num_endmembers
        self.verbose = verbose
        self.snr_input = snr_input
    
    # algoritm
    def estimate_snr(self, Y, r_m, x):
    ...
    def fit(self, Y):
        ...
        # traspose the matrix: (pixel, bandas) to (bandas, pixel)
        Y = Y.T
        ...
        self.Ae = Ae
        self.components_ = np.transpose(Ae)
        self.Indice = indices
        self.Yp = Yp
    ...
    def transform(self, Y):
        S_est = (np.linalg.pinv(self.Ae) @ Y.T).T
        return S_est


class VCA(BC.BaseUnmixing):
    '''
    Class of algorithm VCA
    '''

    def __init__(self, device='CPU', n_endmembers=0, verbose=False, snr_input=0):
        self.model = LibVCA(n_endmembers, verbose, snr_input)
        self.device = device
